from ansible.module_utils.hier_config.text_match import TextMatch
from ansible.module_utils.hier_config import helpers as H
...
class HConfigBase(object):
    ...
    def add_child(self, text, alert_on_duplicate=False, idx=None, force_duplicate=False):
        ...
        if text not in self:
            from ansible.module_utils.hier_config.hc_child import HConfigChild
    ...
    def with_tags(self, tags, new_instance=None):
        ...
        from ansible.module_utils.hier_config import HConfig
